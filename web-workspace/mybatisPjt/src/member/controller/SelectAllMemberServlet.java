...
public class SelectAllMemberServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Member> list = new MemberService().selectAllMember(chkPw,chkName);
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/view/selectAllMember.jsp");
